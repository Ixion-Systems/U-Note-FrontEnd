      ...
      <section className="w-full bg-[#1A1A1A] py-40 flex flex-col items-center justify-center text-center px-4 relative z-10 overflow-hidden mt-32">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center">
            ...
            <button className="flex items-center gap-4 bg-[#FFFFFF] text-[#000000] font-headline-sm text-[20px] border-[3px] border-[#000000] px-8 py-5 hover:-translate-y-1 hover:shadow-[6px_6px_0px_#FF6B00] transition-all uppercase tracking-wider group">
